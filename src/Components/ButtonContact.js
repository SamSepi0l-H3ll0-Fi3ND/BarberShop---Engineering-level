const ButtonContact = () => {
  return (
    <div>
      <label
        for="my-modal-4"
        class="btn btn-ghost border-solid border-main-red rounded-none border-2 invisible sm:visible "
      >
        Contact
      </label>
      ...
      <label for="my-modal-4" class="modal cursor-pointer">
        <label class=" modal-box relative rounded-none bg-main-dark" for="">
          <div className="flex flex-col space-y-4">
            <h3 class="text-lg font-bold text-center underline decoration-main-red underline-offset-8">
              Contact me!
            </h3>
